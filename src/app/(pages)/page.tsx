...
export default function Home() {
  const TextArray = ["NextJS", "ShadcnUI", "Tailwind", "Typescript", "tRPC", "Clerk", "Prisma"]
  return (
      ...
      <div>
        <div className="scroll-m-20 text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-normal lg:text-5xl text-center space-y-3 justify-center">
          ...
          <span className="flex gap-2">
            with
            <TextAnimation className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl" words={TextArray} />
          </span>
        </div>
